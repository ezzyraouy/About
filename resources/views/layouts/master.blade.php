...
<head>
    ...
    <title>Abdelilah Ezzyraouy</title>
    <meta
        content="Abdelilah Ezzyraouy: Aspiring software developer skilled in PHP, Laravel, Vue.js, and more, eager to build impactful and user-friendly digital solutions"
        name="description">
            ...
            <ul>
                ...
                @foreach ($languages as $langCode => $lang)
                    @if ($langCode !== $currentLocale)
                        <li>
                            <a class="d-flex justify-content-center" href="{{ url("/$langCode") }}">
                                <!-- Changed to use direct URL -->
    ...
    <footer id="footer">
        <div class="container">
            ...
            <div class="social-links">
                <a href="https://github.com/ezzyraouy" target="_blank" class="github"><i class="bx bxl-github"></i></a>
                <a href="https://www.linkedin.com/in/abdelilah-ezzyraouy-09a213226/" target="_blank" class="linkedin"><i
